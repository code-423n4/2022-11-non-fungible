...
/**
 * @title TestStandardPolicyERC1155
 * @dev Policy for matching orders at a fixed price for a specific ERC1155 tokenId (only for testing; amount is not determined correctly)
 */
contract TestStandardPolicyERC1155 is IMatchingPolicy {
